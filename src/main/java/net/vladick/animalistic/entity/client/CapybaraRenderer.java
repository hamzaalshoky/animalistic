...
public class CapybaraRenderer extends GeoEntityRenderer<CapybaraEntity> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("animalistic:textures/entity/capybara/capybara.png");
    private static final ResourceLocation SADDLE = new ResourceLocation("animalistic:textures/entity/capybara/capybara_saddled.png");
    ...
    public ResourceLocation getTextureLocation(CapybaraEntity instance) {
        return instance.isSaddled() ? SADDLE : TEXTURE;
    }
