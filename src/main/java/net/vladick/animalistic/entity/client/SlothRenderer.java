...
public class SlothRenderer extends GeoEntityRenderer<SlothEntity> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("animalistic:textures/entity/sloth/sloth.png");
    ...
    @Override
    public ResourceLocation getTextureLocation(SlothEntity instance) {
        return TEXTURE;
    }


    @Override
    public RenderType getRenderType(SlothEntity animatable, float partialTicks, PoseStack stack,
