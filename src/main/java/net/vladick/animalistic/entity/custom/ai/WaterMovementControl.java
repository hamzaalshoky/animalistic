...
public class WaterMovementControl extends MoveControl {
    private final PathfinderMob entity;
    private final float speedMulti;
    private float yawLimit = 3.0F;

    public WaterMovementControl(PathfinderMob entity, float speedMulti) {
        super(entity);
        this.entity = entity;
        this.speedMulti = speedMulti;
    }

    public WaterMovementControl(PathfinderMob entity, float speedMulti, float yawLimit) {
        super(entity);
        this.entity = entity;
